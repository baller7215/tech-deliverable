...
const Quote = ({ quote }) => {
    return (
        <div className='hoverLarge cursor-pointer hover:!scale-95 scale-90 shadow-md w-full min-w-[350px] flex flex-col gap-0 bg-gray-200/90 p-3 rounded-lg font-mono'>
